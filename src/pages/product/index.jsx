        ...
        <div className="product-page__product-container">
            ...
            <div className="product-page__product-info-container">
                ...
                <div className="product-page__count-container">
                    {/* <button onClick={ () => changeQuantity("decrement")} className="product-page__quantity-button">-</button> */}
                    <button onClick={decrement} className="product-page__quantity-button">-</button>
                    {/* <input type="text" onChange={writeQuantity} value={state.quantity} className="product-page__count" /> */}
                    <input type="text" onChange={writeQuantity} value={quantity} className="product-page__count" />
                    {/* <button onClick={ () => changeQuantity("increment")} className="product-page__quantity-button">+</button> */}
                    <button onClick={ increment } className="product-page__quantity-button">+</button>
                </div>
